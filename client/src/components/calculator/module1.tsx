      ...
      <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <Label className="flex items-center text-sm font-medium text-slate-700 mb-1">
                  Weight
                  <TooltipWrapper content="ADA 2025: Weight-based insulin dosing is the standard for TDD calculation in hospitalized patients." />
                </Label>
              ...
              <div>
                <Label className="flex items-center text-sm font-medium text-slate-700 mb-1">
                  Age
                  <TooltipWrapper content="Age >65 increases hypoglycemia risk. ADA recommends starting at lower doses (e.g., 0.3 units/kg)." />
                </Label>
                <div className="relative">
                  <Input
                    type="number"
        ...
        <SummaryPanel 
          data={{
            tdd: results.tdd,
            basal: results.basal,
            bolus: results.nutritional,
            moduleName: "New Insulin Initiation"
          }}
          show={results.tdd !== "--"}
        />
      </CardContent>
